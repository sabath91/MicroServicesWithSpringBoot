...
public class GameServiceImplTest {
    ...
    @Test
    public void processCorrectAttepmtForSocreBadgeTest() {
        final Long userId = 1L;
        ...
        given(badgeCardRepository.findByUserIdOrderByBadgeTimestampDesc(userId)).willReturn(Collections.singletonList(fisrtWonBadge));
